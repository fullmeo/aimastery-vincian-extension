...
export class VincianAnalyzer {
  ...
  async analyzeCode(code: string, language: string): Promise<any> {
    ...
    return {
      ...
      insights: [
        {
          category: 'Curiosità (Curiosité)',
          score: 8,
          message: 'Le code explore plusieurs approches.',
        },
        {
          category: 'Dimostrazione (Démonstration)',
          score: 7,
          message: 'Le code est testé et validé.',
        },
        {
          category: 'Sensazione (Sensation)',
          score: 6,
          message: 'Clarté visuelle modérée du code.',
        },
        {
          category: 'Sfumato (Ambiguïté)',
          score: 9,
          message: "Bonne gestion de l'incertitude et des cas limites.",
        },
        {
          category: 'Arte/Scienza (Art/Science)',
          score: 7,
          message: 'Équilibre entre créativité et rigueur.',
        },
        {
          category: 'Corporalità (Corporalité)',
          score: 8,
          message: 'Structure cohérente et bien organisée.',
        },
        {
          category: 'Connessione (Connexion)',
          score: 8,
          message: 'Bonne intégration avec les autres composants.',
        },
      ],
      suggestions: [
        {
          priority: 'Élevée',
          message: 'Ajouter plus de commentaires explicatifs sur les algorithmes complexes.',
        },
        {
          priority: 'Moyenne',
          message: 'Réduire la duplication de code dans les fonctions X et Y.',
        },
