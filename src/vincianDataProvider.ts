...
export class VincianAnalysisProvider implements vscode.TreeDataProvider<VincianAnalysisItem> {
  private _onDidChangeTreeData: vscode.EventEmitter<VincianAnalysisItem | undefined | void> =
    new vscode.EventEmitter<VincianAnalysisItem | undefined | void>();
  readonly onDidChangeTreeData: vscode.Event<VincianAnalysisItem | undefined | void> =
...
export class VincianAutocodingProvider implements vscode.TreeDataProvider<VincianAnalysisItem> {
  ...
  getChildren(): Thenable<VincianAnalysisItem[]> {
    return Promise.resolve([
      new VincianAnalysisItem("Lancer l'auto-coding", vscode.TreeItemCollapsibleState.None, '', {
        command: 'aimastery-vincian-analysis.startAutoCode',
        title: "Lancer l'auto-coding",
        arguments: [],
      }),
      new VincianAnalysisItem('Tableau de bord vincien', vscode.TreeItemCollapsibleState.None, '', {
